...
const features = [
  ...
  },
  {
    ...
    description: "Seamlessly collaborate on projects with built-in tools and integrations.",
  },
  {
    icon: <Rocket className="h-10 w-10" />,
    title: "Hackathon Central",
    description: "Discover hackathons, form teams, and showcase your projects all in one place.",
  },
  {
    icon: <Zap className="h-10 w-10" />,
    title: "Startup Connect",
    description: "Connect with student startups, find co-founders, and access resources.",
  },
]
